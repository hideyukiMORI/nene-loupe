...
- 外周と前景は単色charcoal `#18181B`。外周は見える幅5、ルーペは中心(105,105)、半径60、
  線幅30、ハンドルは(154,154)から(213,213)へ線幅36で結ぶ。
- レンズ内を別色で塗らず、市松模様を見せる。文字、グラデーション、影、外部画像、フォントは使わない。

NENE-PIXELの4マス構成を参照し、単色ベタ塗りのルーペを重ねた。外径を旧140から150へ、リング線幅を
旧24から30へ、ハンドル線幅を旧30から36へ広げ、小さい表示でも前景の存在感と整った光学重心を保つ。
...
採用SVGのSHA-256は`EDE91D0AB024B01C1EC1311C78FCB3D3D072597610CF6D316B8B29F47334F873`、
派生ICOは`1D40C499A7FCAF4C35FC2EDA753B6AE59664F50FE3C60FFD5A8A2F39AE30C987`である。
